...
import com.example.orderapp.models.ErrorObject;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(NotEnoughGoodsToBuy.class)
    public ResponseEntity<ErrorObject> handleExpenseNotFoundException(NotEnoughGoodsToBuy ex, WebRequest request) {
        ErrorObject errorObject = new ErrorObject();
